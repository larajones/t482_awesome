    ...
    <div class="col-md-3">
        ...
        <ul id ="sort-nav" class = "list-group">
         ...
         <?php echo $list['label'];?>    <i class="fa fa-chevron-down"></i> 
            ...
            <div class="avatar-container" style="background-image: url('../uploads/<?php echo $list['avatar']; ?>')"></div>
            ...
            <label class = "col-sm-2 control-label" for="value">Status: </label>
                <div class = "col-sm-10">
                <input class="form-control input-sm"  type="text" name="status" id="status" value="<?php echo $list['status']; ?>" placeholder="Status" autocomplete="off">
                </div>                    
            </div>        
